import torch
from models.quantization import quan_Conv2d, quan_HardenedConv2d, quan_Linear
...
def hamming_distance(model1, model2):
    ...
    for name, module in model1.named_modules():
        if isinstance(module, quan_Conv2d) or isinstance(module, quan_HardenedConv2d) or isinstance(module, quan_Linear):
